...
fn test_longer_message() {
    let result = md5(b"The quick brown fox jumps over the lazy dog");
...
#[test]
fn test_null_bytes() {
    let result = md5(b"\x00\x00\x00\x00");
...
fn test_from_string_conversion() {
    ...
    let result = md5(message.as_bytes());
...
#[test]
fn test_bit_padding() {
    use l1::*; // Access internal functions for testing
    
    // Note: This test would require making internal functions public for testing
    ...
    assert_eq!(md5(input1), "0cc175b9c0f1b6a831c399e269772661");
    assert_eq!(md5(input2), "187ef4436122d1cc2f40dc2b92f0eba0");
    assert_eq!(md5(input3), "900150983cd24fb0d6963f7d28e17f72");
}
...
fn test_collision_research_vectors() {
    ...
    assert_eq!(md5(b"abcdefghijklmnopqrstuvwxyz"), "c3fcd3d76192e4007dfb496cca67e13b");
