...
fn main() {
    ...
    let msg2 = b"message2";
    println!();
    println!("MD5('message1') = {}", md5_to_hex(&md5(msg1)));
    println!("MD5('message2') = {}", md5_to_hex(&md5(msg2)));
